...
useMotionValueEvent (scrollY, "change", (current) =>{
    ...
    return(
         <div className={`${hidden?"border w-[70vh] mx-auto py-2 rounded-full shadow-xl  -mt-14 px-5":"border w-[100vh]  mx-auto rounded-full shadow-xl  mt-5 "}`}>
            <div className="w-[1px] h-9 bg-[#DDDDDD] absolute left-[80.2vh] top-[13vh]"></div>
            <div className="w-[1px] h-9 bg-[#DDDDDD] absolute right-[80.2vh] top-[13vh]"></div>
        <div className={`grid grid-cols-3 `}>
        {
            ...
            <div>
               ...
               <div className="  ">
                    <div >
                        {hidden?
                        <div className={`flex  items-center justify-between ${index>0?"border-l-3 ps-[24px]":""}  `}>
                            <div>
